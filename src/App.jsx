...
import numerro from './img/Numerro.svg'
import vr from './img/vr.svg'
import v from './img/V.svg'
import fb from './img/FB.svg'
import rrr from './img/rrr.svg'
function App() {
  return (
    <div className="App bg">
      ...
      <body>
        ...
        <div className='text text-[20px] items-start flex font-bold ml-[1700px] mt-[-60px]'>
          <p>VIEW COLLECTION</p>
          <img className='' src={arrow} alt="" />
        </div>
        <div className='box items-center flex justify-between px-28 py-10 mt-[78px]'>
          <img src={numerro} alt=""/>
          <img src={vr} alt=""/>
          <img src={v} alt=""/>
          <img src={fb} alt=""/>
        ...
        <div className='text1 text-[30px] items-start flex font-bold ml-[450px] mt-[-210px]'>
          <p> Basic Shirt</p>
        </div>
        <div className='text1 text-[30px] items-start flex font-bold ml-[490px] mt-[-2px]'>
          <p>€49</p>
        </div>
        <div className='text text-[30px] items-start flex font-bold ml-[1095px] mr-[-100px] mt-[-1px]'>
          <button className='bg-black text-white text-[25px] px-4 py-4 rounded-[10px]'>Shop Shirts</button>
        </div>
        <div className='flex w-full '>
          <img className=' box3 h-[636px] w-[596px]  mt-[170px] mr-[190px] ml-[420px] px-25 py-30 rounded-[10px] ' src={men} alt="" />
         </div>
         <div className=' bg1 mt-[-635px]  w-[650px] h-[636px] ml-[1050px] mb-[600px] rounded-[10px]'></div>
          <p className='text-[40px] items-start flex font-bold ml-[1100px] mt-[-1200px] py-3 w-[516px]  h-[278px]'>“ First Light promises quality, timeless designs and with our mission it is truly a buy it for life purchase. “</p>
          <p className='text-[20px] items-start flex font-bold ml-[1100px] mt-[200px] py-3 '>— Guera Latissa, Creative Director</p>
         
        <div className='text text-[-1px] items-start flex font-bold ml-[460px] mt-[-50px] mr-[200px]'>
          <button className='bg-black text-white text-[18px] px-4 py-4 rounded-[10px]'>Shop Sweaters</button>
        </div>
        ...
        <header className='box6 items-center flex justify-between px-3 py-3'>
          <p className=' front-bold text-[17px] text-[50px] flex font-bold ml-[840px] mt-[130px]'> <b>Hot off the press</b></p>
        </header>
        ...
        <div className=' front-bold text-[17px] text-[50px] flex font-bold ml-[790px] mt-[130px]'>
          <p>Women — Must Haves</p>
        </div>
        <div className='flex w-full rounded-md '>
          <img className=' box5 h-[420px] w-[313px]  mt-[50px] mr-[190px] ml-[390px] px-25 py-30 ' src={model} alt="" />
        ...
        <div className='text1 w-[256px] h-[26px] text-[16px] items-start flex font-bold ml-[410px] mt-[30px]'>
          <p> Basic Shirt</p>
        </div>
        <div className='text1 text-[16px] items-start flex font-bold ml-[650px] mt-[-30px]'>
          <p>€49</p>
        </div>

        <div className='text1 w-[256px] h-[26px] text-[16px] items-start flex font-bold ml-[770px] mt-[-25px]'>
          <p>Beige Jumper</p>
        </div>
        <div className='text1 text-[16px] items-start flex font-bold ml-[1005px] mt-[-25px]'>
          <p>€99</p>
        </div>

        <div className='text1 w-[256px] h-[26px] text-[16px] items-start flex font-bold ml-[1120px] mt-[-25px]'>
          <p>Signature Jacket</p>
        </div>
        <div className='text1 text-[16px] items-start flex font-bold ml-[1350px] mt-[-25px]'>
          <p>€249</p>
        </div>

        <div className='text1 w-[256px] h-[26px] text-[16px] items-start flex font-bold ml-[1470px] mt-[-25px]'>
          <p>Navy Jumper</p>
        </div>
        <div className='text1 text-[16px] items-start flex font-bold ml-[1705px] mt-[-25px]'>
          <p>€340</p>
        </div>
